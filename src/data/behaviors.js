export const names = {
  profiles: {
    ...
    angler: "Pescador",
    atv: "Pessoa em quadriciclo",
    autistic: "Autista",
    camper: "Campista",
    caver: "Explorador de cavernas",
    child1to3: "Criança (1 - 3 anos)",
    child4to6: "Criança (4 - 6 anos)",
    child7to9: "Criança (7 - 9 anos)",
    child10to12: "Criança  (10 - 12 anos",
    child13to15: "Criança (13 - 15 anos)",
    climber: "Escalador",
    dementia: "Pessoa com demência",
    despondent: "Pessoa com quadro depressivo",
    fourwd: "Pessoa em veículo 4x4",
    gatherer: "Coletor/Colecionador",
    hiker: "Trilheiro",
    horsebackrider: "Pessoa à cavalo",
    hunter: "Caçador",
    mentaldisability: "Pessoa com deficiência intelectual",
    mentalillness: "Pessoa com transtorno mental",
    mountainbiker: "Piloto de Mountain-Bike",
    runner: "Corredor",
    skieralpine: "Esquiador (Alpino)",
    skiernordic: "Esquiador (Nórdico)",
    snowboarder: "Pessoa em snowboard",
    snowmobiler: "Pessoa em snowmobile",
    snowshoer: "Pessoa com calçados adaptados à neve",
    substanceabuse: "Pessoa após abuso de substâncias",
    vehicle: "Pessoa em veículos terrestres em geral",
    worker: "Trabalhador",
  },
  environments: {
    temperate: "Temperado",
